...
- [2026-08-17 BattleCommandQueue 提交接口深化](2026-08-17-battle-command-submission-interface-deepening.md) — lifecycle Command RED、旧 helper 重复预注册迁移证据、结构性拒绝零 lifecycle、Queued pending 与完整 Queue/表现/Hand/HUD 回归；未运行 PlayMode/Player/人工 smoke
- [2026-08-17 RunEntryScene 主入口视觉切片](2026-08-17-run-entry-visual-slice.md) — 背景/纸纹来源与 importer、V06 构图、响应式、动画时序、真实 AB 与 1920×1080 实拍证据；未把 21:9/窄窗几何测试冒充实拍
